...
def default_go(data):
    ...
    if len(CreditPolicy.default_list) == 1:
        remove_stop(CreditPolicy.default_list)
        return data
...
def check_highest_reputation(data):
    highest_rep_value = []
    highest_rep = []
    for car in range(0, len(CreditPolicy.default_list)):
        car_rep = CreditPolicy.default_list[car] + ".reputation"
    ...
    for car in range(0, len(CreditPolicy.default_list)):
        ...
        if data[car_rep][0] == max_rep:
            highest_rep.append(CreditPolicy.default_list[car])
...
def check_highest_credit(data):
    ...
    for car in range(0, len(CreditPolicy.default_list)):
        car_rep = CreditPolicy.default_list[car] + ".credits"
    ...
    for car in range(0, len(CreditPolicy.default_list)):
        ...
        if data[car_rep][0] == max_credit:
            highest_credit.append(CreditPolicy.default_list[car])
...
def random_go(vehicle):
    ...
    if traci.vehicle.getStopState(vehicle[togo]) == 1:
        ...
        CreditPolicy.default_list.remove(vehicle[togo])
